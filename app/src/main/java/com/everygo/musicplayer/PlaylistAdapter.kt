...
import com.everygo.musicplayer.databinding.ItemPlaylistBinding
...
class PlaylistAdapter(
    ...
    inner class ViewHolder(private val binding: ItemPlaylistBinding) :
        ...
        fun bind(playlist: Playlist) {
            ...
            binding.tvPlaylistCount.text = binding.root.context.getString(R.string.song_count, playlist.songIds.size)
